...
export interface TranseptorAccountFactoryInterface extends utils.Interface {
  functions: {
...
export interface TranseptorAccountFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TranseptorAccountFactoryInterface;
